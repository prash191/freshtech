...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../../node_modules/bable-poiyflii/dist/main.js":[function(require,module,exports) {
"use strict";
...
var t = {
      ...
      var n = e(9974),
        ...
        f = function (t) {
          var r = 1 == t,
            ...
            l = 7 == t,
            v = 5 == t || p;
          return function (y, b, g, h) {
            for (var x, m, d = a(y), S = i(d), O = n(b, g), w = u(S), j = 0, E = h || c, T = r ? E(y, w) : e || l ? E(y, 0) : void 0; w > j; j++) if ((v || j in S) && (m = O(x = S[j], j, d), t)) if (r) T[j] = m;else if (m) switch (t) {
              case 3:
                return !0;
              case 5:
                return x;
    ...
    8052: (t, r, e) => {
      ...
      t.exports = function (t, r, e, u) {
        ...
        if (n(e) && i(e, s, u), u.global) c ? t[r] = e : a(r, e);else {
          try {
    ...
    2109: (t, r, e) => {
      ...
      t.exports = function (t, r) {
        var e,
          ...
          b = t.global,
          g = t.stat;
        if (e = b ? n : g ? n[y] || u(y, {}) : (n[y] || {}).prototype) for (f in r) {
          if (l = r[f], p = t.dontCallGetSet ? (v = o(e, f)) && v.value : e[f], !s(b ? f : y + (g ? "." : "#") + f, t.forced) && void 0 !== p) {
    ...
    9909: (t, r, e) => {
      ...
      if (a || p.state) {
        ...
        h.get = h.get, h.has = h.has, h.set = h.set, n = function (t, r) {
      ...
      t.exports = {
        ...
        getterFor: function (t) {
          return function (r) {
            var e;
            if (!c(r) || (e = o(r)).type !== t) throw b("Incompatible receiver, " + t + " required");
            return e;
          };
        }
      };
    ...
    6339: (t, r, e) => {
      var n = e(1702),
        ...
        d = t.exports = function (t, r, e) {
          "Symbol(" === b(v(r), 0, 7) && (r = "[" + g(v(r), /^Symbol\(([^)]*)\)/, "$1") + "]"), e && e.getter && (r = "get " + r), e && e.setter && (r = "set " + r), (!a(t, "name") || c && t.name !== r) && (u ? y(t, "name", {
            value: r,
            configurable: !0
          ...
          var n = p(t);
          return a(n, "source") || (n.source = h(m, "string" == typeof r ? r : "")), t;
        };
    ...
    9653: (t, r, e) => {
      var n = e(2109),
        ...
        T = c("".slice),
        L = c("".charCodeAt),
        P = s(S, !O(" 0o1") || !O("0b1") || O("+0x1")),
        I = function (t) {
          var r,
            e = arguments.length < 1 ? 0 : O(function (t) {
              var r = y(t, "number");
              return "bigint" == typeof r ? r : function (t) {
                var r,
                  ...
                  c,
                  s = y(t, "number");
                if (v(s)) throw E("Cannot convert a Symbol value to a number");
                if ("string" == typeof s && s.length > 2) if (s = d(s), 43 === (r = L(s, 0)) || 45 === r) {
                  ...
                  for (a = (i = T(s, 2)).length, u = 0; u < a; u++) if ((c = L(i, u)) < 48 || c > o) return NaN;
                  return parseInt(i, n);
                }
                return +s;
              }(r);
            }(t));
          return l(j, r = this) && b(function () {
            m(r);
          }) ? p(Object(e), this, I) : e;
        };
      I.prototype = j, P && !o && (j.constructor = I), n({
        global: !0,
        constructor: !0,
        wrap: !0,
        forced: P
      ...
      var N = function (t, r) {
        for (var e, n = i ? g(r) : "MAX_VALUE,MIN_VALUE,NaN,NEGATIVE_INFINITY,POSITIVE_INFINITY,EPSILON,MAX_SAFE_INTEGER,MIN_SAFE_INTEGER,isFinite,isInteger,isNaN,isSafeInteger,parseFloat,parseInt,fromString,range".split(","), o = 0; n.length > o; o++) f(r, e = n[o]) && !f(t, e) && x(t, e, h(r, e));
      };
      o && w && N(u[S], w), (P || o) && N(u[S], O);
    },
    7941: (t, r, e) => {
      var n = e(2109),
        o = e(7908),
...
(() => {
  e.r(n), e.d(n, {
    default: () => r
  }), e(9653), e(1539), e(4747), e(7941), e(9714);
  var t = {
    update: function () {},
    transN: function (t) {
      return Number(t);
    },
    stringToN: function (t) {
      return t >= 10 ? t : "0" + t;
    },
    dontShake: function (t, r, e) {
      if ("function" != typeof t) throw new TypeError("func must be a function!");
      if (void 0 === r && (r = 500, e = !1), "boolean" == typeof r && (e = r, r = 500), void 0 === e && (e = !1), "number" != typeof r) throw new TypeError("wait must be a number!");
      if ("boolean" != typeof e) throw new TypeError("immediate must be a boolean!");
      var n,
        o = null;
      return function () {
        ...
        return o && clearTimeout(o), o = setTimeout(function () {
          clearTimeout(o), o = null, e || (n = t.apply(c, a));
        }, r), s && (n = t.apply(c, a)), n;
      };
    }
  };
  Object.setPrototypeOf(t, null), Object.keys(t).forEach(function (r) {
    Object.defineProperty(t, r.toString(), {
      writable: !1,
      enumerable: !1
    });
  });
...
var o = exports.default = n.default;
...
var displayMap = exports.displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (location) {
    var coordinate = location.coordinates;
    var marker = L.marker([coordinate[1], coordinate[0]]).addTo(map);
    marker.bindPopup("<p>Day ".concat(location.day, ": ").concat(location.description, "</p>")).openPopup();
...
exports.showAlerts = exports.hideAlerts = void 0;
var hideAlerts = exports.hideAlerts = function hideAlerts() {
  var el = document.querySelector('.alert');
  if (el) el.parentElement.removeChild(el);
};
var showAlerts = exports.showAlerts = function showAlerts(type, message) {
  hideAlerts();
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alert.showAlerts)('success', 'You are now logged in.');
        ...
        case 7:
          ...
          (0, _alert.showAlerts)('error', _context.t0.response.data.message);
        case 10:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 8:
          ...
          (0, _alert.showAlerts)('error', _context2.t0.response.data.message);
        case 11:
        case "end":
...
var updateSettings = exports.updateSettings = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    var usersEndpoint, url, res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          usersEndpoint = 'http://localhost:3000/api/v1.0/users';
          url = type === 'password' ? usersEndpoint + '/updatePassword' : usersEndpoint + '/updateMe';
          _context.prev = 2;
          _context.next = 5;
          return (0, _axios.default)({
            method: 'PATCH',
        ...
        case 5:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alert.showAlerts)('success', "Account ".concat(type[0].toUpperCase() + type.slice(1), " successfully updated."));
          }
          _context.next = 12;
          break;
        case 9:
          ...
          (0, _alert.showAlerts)('error', 'Error while updating the details.');
        case 12:
        case "end":
          return _context.stop();
      }
...
var accountUpdateForm = document.querySelector('.form-user-data');
var passwordUpdateForm = document.querySelector('.form-user-settings');
if (mapBox) {
...
if (accountUpdateForm) {
  accountUpdateForm.addEventListener('submit', function (e) {
    e.preventDefault();
...
},{"bable-poiyflii":"../../node_modules/bable-poiyflii/dist/main.js","./mapbox":"mapbox.js","./login":"login.js","./updateSettings":"updateSettings.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
